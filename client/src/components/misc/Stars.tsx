...
const Stars = ({ difficulty, onChange, showText = false }: StarsProps) => {
  const MAX_STARS = 5;
  ...
  return (
    <div className="flex items-center gap-1">
      {
        showText &&
          <span className="text-tertiary font-bold mr-1 w-15 text-right">{convertDifficultyToText(difficulty)}</span>
      }
